...
export default function Home() {
	...
	if (adminLoading || serviceAdminLoading || anyAdminLoading) {
		return (
			<div className="constrained-width container mx-auto bg-white min-h-screen flex flex-col items-center justify-center py-4 px-4">
								...
								<Card>
									...
									<CardContent>
										<p className="text-sm text-gray-500">
											...
											document requirements, and appointments for your
											department.
										</p>
									</CardContent>
									<CardFooter>
