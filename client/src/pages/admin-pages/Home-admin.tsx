...
// 				`http://localhost:3000/api/departments/${updateData.id}`,
// 				{
// 					method: "PUT",
...
// 		try {
// 			const res = await fetch(
// 				`http://localhost:3000/api/departments/${deleteDeptId}`,
// 				{
// 					method: "DELETE",
// 					headers: {
// 						Authorization:
...
// 							{/* Update */}
// 							<Dialog
// 								open={showUpdateModal && updateData.id === dept.id}
...
// 											className="px-4 py-2 bg-[#600D29] text-white rounded">
// 											Update
// 										</button>
// 									</DialogFooter>
// 								</DialogContent>
...
// 				<DialogTrigger asChild>
// 					<button className="w-full bg-[#600D29] text-white py-2 rounded-lg mt-4">
// 						Add Department
// 					</button>
// 				</DialogTrigger>
// 				<DialogContent className="backdrop-blur-sm">
